 ...
 * @author 陈光曦
 */
public class BondTypeProcessor extends TextProcessor {

    FundDoc fundDoc = new FundDoc("（2012-12-17）证券投资基金基金合同填报指引第3号——债券型证券投资基金基金合同填报指引（试行）.doc");

    public BondTypeProcessor() {
